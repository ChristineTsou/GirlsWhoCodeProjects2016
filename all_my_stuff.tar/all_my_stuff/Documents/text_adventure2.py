...
while done!=True:
	print(start)
	print("Will you go right? yes or no. no for left.")
	user_input = input()
	if user_input == "no":
		...
		if user_input=="no":
			...
			user_input=input("Do you go to the house and knock(yes) or do you continue walking?(no) ")
			if user_input=="yes":
			...
			user_input=input("Do you jump out and swim(yes) or do you continue to row(no)? ")
			if user_input=="yes":
			...
			if user_input=="no":
				...
				user_input=input("Will you grab the wood(yes) or swim hard instead(no)? ")
				if user_input=="no":
					print("The current is harder to swim across than expected. You drown")
				if user_input=="yes":
					...
					user_input=input("Will you wait? Or head in now? yes for wait, no for head in now ")
					if user_input=="yes":
		...
		user_input=input("You can either stay in the hallway or head out in the rain. Will you head out? yes or no ")
		if user_input=="no":
		...
		if user_input=="yes": 
			...
			user_input=input("Should you check it out? it could be a trap. On the other hand, the bite you've gotten might need some attention. Will you check out the light? yes or no " )
			if user_input=="no":
